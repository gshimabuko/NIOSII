...
# Memory: CODE_MEMORY
MEM_0 := traffic_light_CODE_MEMORY
$(MEM_0)_NAME := CODE_MEMORY
...
$(MEM_0)_HIERARCHICAL_PATH := CODE_MEMORY
$(MEM_0)_WIDTH := 32
...
.PHONY: CODE_MEMORY
CODE_MEMORY: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
