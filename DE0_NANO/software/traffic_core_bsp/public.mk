...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../traffic_light.sopcinfo
...
# Design Name 
# setting SOPC_NAME is traffic_light
SOPC_NAME := traffic_light
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x410c0
SOPC_SYSID_FLAG += --sidp=0x410c0
ELF_PATCH_FLAG  += --sidp 0x410c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1589251516
SOPC_SYSID_FLAG += --timestamp=1589251516
ELF_PATCH_FLAG  += --timestamp 1589251516
